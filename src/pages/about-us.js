      ...
      <main>
          ...
          <div className="w-full sm:w-[80%] xl:w-[62%] flex py-[30px] bg-[#E6F0EC] sm:-mt-[125px]">
            ...
            <div className="w-[70%] sm:w-[62%] sm:pr-[8%]">
              <p className="text-[#006b3d] text-[16px] sm:text-[21px] xl:text-[26px] leading-[34px] xl:leading-[36px] font-medium">
                ...
                เพื่อส่งมอบผลลัพธ์ที่ดีที่สุดสำหรับผู้ป่วย
        ...
        <section className="mt-[70px] sm:mt-[125px] max-w-[1270px] mx-auto ">
          <div className="mx-7 xl:mx-0">
            ...
            <img
              src={aboutUs}
              className="text-center mx-auto mt-[40px] sm:mt-0"
              alt=""
            />
            <p className="text-[#2a3d53] text-2xl leading-[36px] text-center mt-[30px]">
              บริษัทเมดิไทม์จำกัดดำเนินกิจการมาตั้งแต่ปี 2551
              โดยให้บริการเครื่องมือแพทย์ในประเทศไทย
              เราคือผู้เชี่ยวชาญสินค้าทางด้าน
